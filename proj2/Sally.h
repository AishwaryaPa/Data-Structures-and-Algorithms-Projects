...
private:
   ...
   static void doEXC(Sally *Sptr) ;

   static void compareLT(Sally *Sptr) ;
   static void compareLTE(Sally *Sptr) ;
   static void compareE(Sally *Sptr) ;
   static void compareNE(Sally *Sptr) ;
   static void compareGT(Sally *Sptr) ;
   static void compareGTE(Sally *Sptr) ;
